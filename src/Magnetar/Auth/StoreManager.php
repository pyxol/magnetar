<?php
	...
	use Magnetar\Auth\Store;
	
	/**
	 * Auth storage manager
	 * 
	 * @see \Magnetar\Auth\Store
	 */
	class StoreManager {
		/**
		...
		protected array $adapters = [
			//'oauth' => OAuth\Store::class,
			'session' => Session\Store::class,
			'cookie' => Cookie\Store::class,
			//'api' => API\Store::class,
		];
		 ...
		 * @throws \Exception
		 */
		public function connection(string|null $connection_name=null): Store {
		 ...
		 * @throws \Exception
		 */
		public function adapter(string $connection_name): Store {
